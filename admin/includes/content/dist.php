<?php 
	...
	$list = $Dist->get_dist_list($param)['data'];
...
?>
 ...
 <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
		...
		<div class="box-body">
			<div class="row">
                    ...
                    <div class="col-sm-2">
                    	<h2>
                    		<button style="float:right"  type="button" class="btn btn-info" onclick="window.location='./?url=dist&tab=Add'">Add New<i class="ace-icon fa fa-plus icon-on-right bigger-110"></i></button>
                    	</h2>
                    </div>
                </div>
						<div class="row">
											...
											<tbody>
                                           	...
                                           	foreach ($list as $key => $value) {
                                           		...
                                           		echo '<tr>
                                           				...
                                           				<td><a href="?url=dist&tab=Edit&id='.$value['id'].'" class="btn btn-success">Edit</a>&nbsp;&nbsp;<a href="./form_handler.php?action=manageDist&type=Delete&id='.$value['id'].'&accessToken='.$_SESSION[$_SESSION_ID]['accessToken'].'" class="btn btn-danger">Delete</a></td>
                                           		     </tr>';
                                           	}
	...
	if($tab=="Edit")
	{
		...
		$details = $Dist->get_dist_details($param)['data'];
	} 
	?> 
			<div class="box">
					<div class="box-body">
					...
					<div class="row" style="padding:0 30px;">
	                    ...
	                    <div class="col-sm-2">
	                    	<h2>
	                    		<button style="float:right"  type="button" class="btn btn-info" onclick="window.location='./?url=dist&tab=View'">Back<i class="ace-icon fa fa-reply icon-on-right bigger-110"></i></button>
	                    	</h2>
	                    </div>
	                </div>
							<div class="col-xs-9">
								...
								<form class="form-horizontal" role="form" action='form_handler.php' method="post" enctype="multipart/form-data">
									...
									<input type="hidden" name="action" value="manageDist" >
...
<?php //echo '<pre>';print_r($list);  ?>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Dist Name</label>

										<div class="col-sm-9">
										<input type="text" class="form-control" name="dist_name" required placeholder="Dist Name" value="<?= isset($details)?$purifier->purify($details->dist_name):'' ?>" title="Dist Name"><br>
