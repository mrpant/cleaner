<?php 
	...
	$list = $Rooms->get_rooms_list($param)['data'];
...
?>
 ...
 <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
		...
		<div class="box-body">
			<div class="row">
                    ...
                    <div class="col-sm-2">
                    	<h2>
                    		<button style="float:right"  type="button" class="btn btn-info" onclick="window.location='./?url=rooms&tab=Add'">Add New<i class="ace-icon fa fa-plus icon-on-right bigger-110"></i></button>
                    	</h2>
                    </div>
                </div>
						<div class="row">
											...
											<tbody>
                                           	...
                                           	foreach ($list as $key => $value) {
                                           		...
                                           		echo '<tr>
                                           				...
                                           				<td><a href="?url=rooms&tab=Edit&id='.$value['id'].'" class="btn btn-success">Edit</a>&nbsp;&nbsp;<a href="./form_handler.php?action=manageRooms&type=Delete&id='.$value['id'].'&accessToken='.$_SESSION[$_SESSION_ID]['accessToken'].'" class="btn btn-danger">Delete</a></td>
                                           		     </tr>';
                                           	}
	...
	if($tab=="Edit")
	{
		...
		$details = $Rooms->get_rooms_details($param)['data'];
	} 
	?> 
			<div class="box">
					<div class="box-body">
					...
					<div class="row" style="padding:0 30px;">
	                    ...
	                    <div class="col-sm-2">
	                    	<h2>
	                    		<button style="float:right"  type="button" class="btn btn-info" onclick="window.location='./?url=rooms&tab=View'">Back<i class="ace-icon fa fa-reply icon-on-right bigger-110"></i></button>
	                    	</h2>
	                    </div>
	                </div>
							<div class="col-xs-9">
